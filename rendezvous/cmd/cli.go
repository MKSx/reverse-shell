...
func GetCommand() *cobra.Command {
	...
	command := &cobra.Command{
		...
		Short: "An http server listening for agents and clients",
		Long: "The rendezvous is an http server listening for agents and clients.	It can run behind a reverse-proxy and that reverse-proxy could to SSL offloading.",
